...
def parse_news_2015(infname, 
    ...
    for name_id, name in enumerate(root): 
        srcnode=name.find('SourceName')
        #name_id=name.attrib['ID']
        ...
        for idx, tgtnode in enumerate(children):
#            print idx
            tgt_id=tgtnode.attrib['ID']
            tgt_text=tgtnode.text
...
def generate_news_2105_output(id_fname,src_fname,tgt_fname,out_fname,systemtype,corpus,srclang,tgtlang,topk=10):
...
def generate_news_2105_gold_standard(src_fname,tgt_fname,out_fname,corpus,corpus_size,srclang,tgtlang):
...
if __name__=='__main__': 
    ...
    commands={
        ...
        'gen_news_output':generate_news_2105_output,
        'generate_news_2105_gold_standard':generate_news_2105_gold_standard,
